...
rpmbootstrap $BASE_URL /mnt "dnf" "passwd" "vim-minimal" "strace" "less" "policycoreutils" "grubby" "kernel" "tar" "openssh-server" "openssh-clients" "avahi" "NetworkManager" "iproute" "iputils" "cryptsetup"
