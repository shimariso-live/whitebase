...
rpmbootstrap -x /usr/libexec/platform-python $BASE_URL /mnt "dnf" "miraclelinux-repos"

echo -e 'search local\nnameserver 8.8.8.8\nnameserver 8.8.4.4\nnameserver 2001:4860:4860::8888\nnameserver 2001:4860:4860::8844' > /mnt/etc/resolv.conf

rm /mnt/var/lib/rpm/*
chroot /mnt rpm --rebuilddb
echo 8 > /mnt/etc/dnf/vars/releasever
chroot /mnt dnf install -y "dnf" "passwd" "vim-minimal" "strace" "less" "kernel" "tar" "openssh-server" "openssh-clients" "avahi" "NetworkManager" "iproute" "qemu-guest-agent"
